...
import useGetLPTokenAmounts from '@/hooks/useGetLPTokenAmounts';
...
import useGetRewarders from '@/hooks/useGetRewarders';
import { findMergePoolAddress } from '@/helpers/replicaRewards';
import BN from 'bn.js';
import { getRewarder, QuarryRewarderInfo } from '@/helpers/rewarder';
import useGetStakePoolAPY from '@/hooks/useGetStakePoolAPY';
import useGetPoolInfo from '@/hooks/useGetPoolnfo';
