...
export const useSDKInternal = () => {
    ...
    const owner = useMemo(() => sdkMut?.provider.wallet.publicKey ?? null, [sdkMut?.provider.wallet.publicKey]);
...
export const { useContainer: useSDK, Provider: SDKProvider } = createContainer(useSDKInternal);
