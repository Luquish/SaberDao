  ...
  return (
    <>
      {wallet ? (
        <>
          <button
            className={"px-3 py-1 flex items-center gap-2 justify-between rounded border dark:(text-white border-none bg-warmGray-800 hover:bg-coolGray-800) z-20 md:z-auto"}
            ref={setTargetRef}
            onClick={() => {
