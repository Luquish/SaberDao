    ...
    <SubscriptionCard
      ...
      switchGroup={
        visibilityState.isToggleVisible ? (
          <Switch.Group>
            <div tw="flex items-center justify-between py-2 px-4 border-b text-sm border-gray-800">
              <Switch.Label tw="font-medium text-gray-400">
              ...
              <Switch<"button">
                ...
                tw={[
                  isSubscribed ? "bg-gray-50" : "bg-gray-600",
