...
export const GaugeForemanEC = () => {
    ...
    return (React.createElement(ChecklistItem, { title: "Gaugemeister foreman is the Executive Council's Owner Invoker", pass: gmData === undefined || ownerInvokerKey === undefined
            ? undefined
            : foremanIsEC },
        ...
        React.createElement(AsyncButton, { disabled: !isForeman, variant: "primary", onClick: async (sdkMut) => {
                invariant(gmData);
