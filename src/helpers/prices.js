...
export const getPoolTokenPercentages = (pool) => {
    // Get amount token A and B, and their USD prices, and calculate TVL
...
const priceCache = {};
export const getPrice = async (mint, decimals) => {
    ...
    try {
        ...
        Object.values(result.data).forEach((priceRecord) => {
