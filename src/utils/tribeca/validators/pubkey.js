 ...
 */
export const YupPublicKey = Yup.string().test("Public Key", "Invalid public key", (str) => {
    if (!str) {
        return true;
    }
    try {
...
export const YupKeypair = Yup.string().test("Keypair", "Invalid keypair JSON", (str) => {
    if (!str) {
        return true;
    }
    try {
...
export const kpSeedToKP = (secretKey) => {
