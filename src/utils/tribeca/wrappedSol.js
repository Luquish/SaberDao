...
import { getATAAddress, getOrCreateATA, NATIVE_MINT, SPLToken, TOKEN_PROGRAM_ID, TokenAccountLayout, } from "@saberhq/token-utils";
...
export const wrapAndSendSOLToATA = async ({ provider, amount, accountKP = Keypair.generate(), owner = provider.wallet.publicKey, skipATACreation = false, }) => {
