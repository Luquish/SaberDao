...
export const calculateLPTokenAmount = (exchange, amountA, amountB, isDeposit) => {
    const D0 = computeD(exchange.ampFactor, exchange.reserves[0].amount.raw, exchange.reserves[1].amount.raw);
